(function() {
  var BasicAI, PlayerState, State, action, applyBenefit, basicCard, c, card, compileAndPlay, count, countStr, duration, makeCard, makeStrategy, numericSort, playGame, playStep, shuffle, stringify, transferCard, transferCardToTop;
  ...
  BasicAI = (function() {
    ...
    BasicAI.prototype.chooseBuy = function(state, choices) {
  ...
  State = (function() {
    ...
    State.prototype.doBuyPhase = function() {
      ...
      while (this.current.buys > 0) {
        ...
        choice = this.current.ai.chooseBuy(this, buyable);
        if (choice === null) {
          return;
        }
        ...
        this.current.potionCost -= potionCost;
        this.current.buys -= 1;
    ...
    State.prototype.attackPlayer = function(player, effect) {
      ...
      if (!player.moatProtected && (_ref2 = !c.Lighthouse, __indexOf.call(player.duration, _ref2) >= 0)) {
