...
(function() {
  ...
  compileStrategies = function(scripts, errorHandler) {
    var e, i, strategies, strategy, usedNames, _i, _ref, _ref1;
    strategies = [];
    usedNames = [];
  ...
  playGame = function(strategies, options, ret) {
    var ai, ais, err, errorHandler, item, state, _ref;
    ais = (function() {
  ...
  makeCard('Ambassador', attack, {
    cost: 3,
    playEffect: function(state) {
      var card, cardName, choice, choices, count, counts, i, quantity, _i, _j, _len, _ref;
      counts = {};
      _ref = state.current.hand;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        card = _ref[_i];
  ...
  State = (function() {
    ...
    State.prototype.doTreasurePhase = function() {
      var card, validTreasures, _i, _len, _ref1;
      while (true) {
        validTreasures = [null];
        _ref1 = this.current.hand;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
